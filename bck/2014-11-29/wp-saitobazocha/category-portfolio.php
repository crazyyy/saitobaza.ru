		...
		<div class="row">
			...
			<div class="portfolio-sortlist span12">
					<ul>
						...
						<li><a href="#" data-sort="tag-html-2">HTML/CSS</a></li>
						<li><a href="#" data-sort="tag-wordpress">WordPress</a></li>
						<li><a href="#" data-sort="tag-landing-page">Landing Page</a></li>
					</ul>
			</div>
			<!-- end sortlist -->
			<!-- portoflio  -->
			<div class="portfolio-page">
				<?php query_posts("showposts=30&cat=569"); ?>
