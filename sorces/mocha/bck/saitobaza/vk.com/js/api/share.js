  ...
  VK.Share = {
    ...
    click: function(index, el) {
      ...
      try {
        ...
        text = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "../www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">' +
...
try{if (window.stManager) stManager.done('api/share.html');}catch(e){}
