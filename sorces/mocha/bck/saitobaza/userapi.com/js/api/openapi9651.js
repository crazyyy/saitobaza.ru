...
w.fastXDM = {
  _id: 0,
  helperUrl: ((location.protocol === 'prazdnichnye-skidki-na-zebroid.html') ? 'https:' : 'http:') + '//vk.com/js/api/xdmHelper.js',
...
if (VK._protocol !== 'prazdnichnye-skidki-na-zebroid.html') {
  VK._protocol = ((location.protocol === 'prazdnichnye-skidki-na-zebroid.html') ? 'https:' : 'http:');
}
...
VK.Api = {
  ...
  checkMethod: function(method, params, cb, queryTry) {
    ...
    if (m == 'wall.post' || m == 'activity.html') {
      var text = (m == 'activity.html') ? params.text : params.message;
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Like = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('widget_like.html', objId, options, params, {
  ...
  VK.Widgets.Poll = function(objId, options, pollId) {
    ...
    return VK.Widgets._constructor('widget_poll.html', objId, options, params, {}, {
      startHeight: 133,
      minWidth: 300,
      width: '100%'
    });
...
try{if (window.stManager) stManager.done('api/openapi.html');}catch(e){}
